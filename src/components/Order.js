...
const array = postOrder.map((menu, i) => {
    ...
    return( 
          ...
          <Table>
                ...
                <TableBody>
                  <tr>
                 <td width="200"  pr-1>{menu.user}</td>
   ...
   return(<div>
      ...
      {array}
       <button type="button" onClick={this.handleViewOrder} className="btn btn-primary ">Pedidos  <FontAwesomeIcon icon="clipboard-list" /></button>
       </div>)
